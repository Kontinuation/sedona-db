...
impl GeometryTypeSet {
    ...
    fn add(&mut self, type_and_dim: &GeometryTypeAndDimensions) {
        let bit_position = match type_and_dim.geometry_type() {
            ...
            sedona_geometry::types::GeometryTypeId::MultiPoint => 3,
            sedona_geometry::types::GeometryTypeId::MultiLineString => 4,
            sedona_geometry::types::GeometryTypeId::MultiPolygon => 5,
            sedona_geometry::types::GeometryTypeId::GeometryCollection => 6,
        } + match type_and_dim.dimensions() {
